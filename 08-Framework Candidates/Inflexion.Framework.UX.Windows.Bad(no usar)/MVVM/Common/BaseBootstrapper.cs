// -----------------------------------------------------------------------
// <copyright file="BaseBootstrapper.cs" company="Inflexion">
...
namespace Inflexion.Framework.UX.Windows.MVVM
{
    ...
    using Inflexion.Framework.UX.Windows.MVVM.Adapters;
    ...
    public abstract class BaseBootstrapper : UnityBootstrapper
    {
        ...
        protected override void InitializeShell()
        {
            ...
            if (shell != null)
            {
                ...
                regionManager.RegisterViewWithRegion(RegionNames.WorkspaceRegion, typeof(Inflexion.Framework.UX.Windows.MVVM.Views.Presentation.PresentationView));
            ...
            object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            FaultException<ValidationException> validationException = e.Exception as FaultException<ValidationException>;
            ...
            FaultException<InternalException> faultObject = e.Exception as FaultException<InternalException>;
            if (faultObject != null)
            {
                // Mostramos el mensaje.
                messageBoxService.Show(
