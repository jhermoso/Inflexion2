// -----------------------------------------------------------------------
// <copyright file="ViewModelBase.cs" company="Inflexion">
...
namespace Inflexion.Framework.UX.Windows.MVVM.CRUD
{
    ...
    /// </remarks>
    public abstract class CrudViewModel<T> : WorkspaceViewModel, IEntityViewModel where T : BaseEntityDataTransferObject
    {
        ...
        public virtual int Id
        {
            ...
            set
            {
                if (this.ObjectElement.Id != value)
                {
        ...
        {
            return this.ObjectElement != null && Validation.ValidateAll().IsValid && this.Activo;
        }
...
} // Inflexion.Framework.UX.Windows.MVVM.CRUD