...
namespace Needel.Common.Domain
{
    ...
    /// </remarks>
    public interface IUser : Inflexion2.Domain.IEntity<Int32>  , IEquatable<IUser>, IComparable<IUser>
    {
        ...
        /// </value>
        User SetUserDepartment ( Department department );
