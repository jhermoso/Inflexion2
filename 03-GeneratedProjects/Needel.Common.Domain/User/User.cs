...
namespace Needel.Common.Domain
{
    ...
    [Serializable]
    public partial class User : Inflexion2.Domain.Entity<User, Int32>, IUser , IEquatable<User>, IComparable<User>
    {
        ...
        {
            this.SetAddresses(new System.Collections.Generic.List<Address>());
        ...
        /// </param>
        /// <param name="users">
        /// Parametro <see cref="User.Users"/> del constructor de campos mandatory de la clase <see cref="User"/>
        /// Propiedad de unica instancia deducida del source rol source de una relación
        /// </param>
        /// <param name="userAddress">
        /// Parametro <see cref="User.UserAddress"/> del constructor de campos mandatory de la clase <see cref="User"/>
        /// Propiedad  de colección (Target) deducida del target rol source de una relación
        /// </param>
        protected internal User( 
                                 string name,
                                 Department userDepartment,
                                 System.Collections.Generic.List<Address> userAddress ) :  this()  //cbc.isDerivedFromOneEntity ='False', IsDerived(cbc.entitySuperClass ) = ''
        {
            ...
            this.Name = name;
            SetUserDepartment( userDepartment ); /*mandatoryPropertyFromSources*/
            SetAddresses( addresses ); /*mandatoryPropertyFromTargets*/
        ...
        public virtual Department UserDepartment 
            {
                get 
                {
        ...
        /// Parametro con el que establecemos el nuevo valor de <see cref="UserDepartment"/>. de la clase <see cref="User"/>
        /// </param>
        /// <returns>
        /// .en return value: the own object to allow fluent calls
        /// .es Devuelve el propio objeto para facilitar las interfaces 'fluent'/>
        /// </returns>
        public virtual User SetUserDepartment ( Department department )
        {
            //Guard.ArgumentIsNotNull( department, "El parametro user es null");          // si la multiplicidad minima es cero entonces puede ser null
        ...
        public virtual IUser AddAddressToAddresses ( Address address )
        {
            ...
            address.SetUserAddress(this); // Relación bidereccional: es necesario establecer el valor en el rol opuesto.
            return this;
        }
