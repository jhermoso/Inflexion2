...
namespace Needel.Common.Domain
{
    ...
    {
        #region User Basic Specifications
        ...
        /// </param>
        /// <returns>
        /// Devuelve <see cref="Specification{User}"/> asociado con este criterio.
        /// </returns>
        public static Specification<User> FindAllByName(string name)
        {
            // Especificación para User por Name
            Specification<User> specification =
                            new DirectSpecification<User>(c => c.Name == name);
        ...
        #region User Complex Specifications
        #endregion
