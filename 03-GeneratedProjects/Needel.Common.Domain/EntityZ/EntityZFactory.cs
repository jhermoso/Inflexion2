...
namespace Needel.Common.Domain
{
    ...
    /// <summary>
    /// Clase factoría para la creación de  una entidad de tipo <see cref="EntityZ"/>.
    /// </summary>
    static public class EntityZFactory 
    {

        #region Constructor vacio de la clase
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="EntityZFactory"/>.
        /// </summary>
        /// <remarks>
        /// Constructor vacío de la clase <see cref="EntityZFactory"/>.
        /// </remarks>
        /// <returns>
        /// Devuelve una instancia de dela clase EntityZFactory />
        /// </returns>
        static EntityZFactory()
        {
        }
        #endregion
        ...
        /// </summary>
        /// <remarks>
        /// Crea una entidad de tipo <see cref="EntityZ"/>
        /// </remarks>
        /// <param name="name"> 
        /// 
        /// </param>
        /// <returns>
        /// Devuelve  una entidad de tipo <see cref="EntityZFactory"/>
        /// </returns>
        public static EntityZ Create(string name)
        {
            // Creamos la nueva entidad.
            EntityZ EntityEntityZ = new EntityZ(  name );
            //devolvemos la entidad recien creada
            return EntityEntityZ;
        }

        #endregion

    } // end class EntityZFactory
