...
namespace Needel.Common.Domain
{
    ...
    /// </remarks>
    public interface IEntityM : Inflexion2.Domain.IAggregateRoot<IEntityM, Int32>  , IEquatable<IEntityM>, IComparable<IEntityM>
    {
        ...
        System.Collections.Generic.List<MNZ> NZs { get; }
        ...
        /// </value>
        IEntityM RemoveMNZFromNZs ( MNZ mNZ );
