...
namespace Needel.Common.Domain
{
    ...
    /// <summary>
    /// Clase factoría para la creación de  una entidad de tipo <see cref="GraphNode"/>.
    /// </summary>
    static public class GraphNodeFactory 
    {

        #region Constructor vacio de la clase
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="GraphNodeFactory"/>.
        /// </summary>
        /// <remarks>
        /// Constructor vacío de la clase <see cref="GraphNodeFactory"/>.
        /// </remarks>
        /// <returns>
        ...
        /// </summary>
        /// <remarks>
        /// Crea una entidad de tipo <see cref="GraphNode"/>
        /// </remarks>
        /// <param name="name"> 
        /// 
        /// </param>
        /// <returns>
        /// Devuelve  una entidad de tipo <see cref="GraphNodeFactory"/>
        /// </returns>
        public static GraphNode Create(string name)
        {
            // Creamos la nueva entidad.
            GraphNode EntityGraphNode = new GraphNode(  name );
