...
namespace Needel.Common.Domain
{
    ...
    static public class AppSettingFactory 
    {
        ...
        /// </returns>
        public static AppSetting Create(  string key, string value, AppSettingType appSettingUsing  )
        {
            // Creamos la nueva entidad.
            AppSetting EntityAppSetting = new AppSetting(  key, value, appSettingUsing );
