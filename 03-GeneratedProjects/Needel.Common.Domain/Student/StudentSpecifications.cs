...
namespace Needel.Common.Domain
{
    ...
    {
        #region Student Basic Specifications
        ...
        /// </param>
        /// <returns>
        /// Devuelve <see cref="Specification{Student}"/> asociado con este criterio.
        /// </returns>
        public static Specification<Student> FindAllByName(string name)
        {
            // Especificación para Student por Name
            Specification<Student> specification =
                            new DirectSpecification<Student>(c => c.Name == name);
        ...
        #region Student Complex Specifications
        #endregion
