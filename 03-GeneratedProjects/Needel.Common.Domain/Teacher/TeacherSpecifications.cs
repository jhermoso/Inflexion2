...
namespace Needel.Common.Domain
{
    ...
    /// </remarks>
    public static class TeacherSpecifications
    {
        #region Teacher Basic Specifications
        ...
        /// </param>
        /// <returns>
        /// Devuelve <see cref="Specification{Teacher}"/> asociado con este criterio.
        /// </returns>
        public static Specification<Teacher> FindAllByName(string name)
        {
            // Especificación para Teacher por Name
            Specification<Teacher> specification =
                            new DirectSpecification<Teacher>(c => c.Name == name);
        ...
        #region Teacher Complex Specifications
        #endregion
