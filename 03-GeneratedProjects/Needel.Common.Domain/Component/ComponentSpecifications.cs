...
namespace Needel.Common.Domain
{
    ...
    /// </remarks>
    public static class ComponentSpecifications
    {
        #region Component Basic Specifications
        ...
        /// </param>
        /// <returns>
        /// Devuelve <see cref="Specification{Component}"/> asociado con este criterio.
        /// </returns>
        public static Specification<Component> FindAllByName(string name)
        {
            // Especificación para Component por Name
            Specification<Component> specification =
                            new DirectSpecification<Component>(c => c.Name == name);
        ...
        #region Component Complex Specifications
        #endregion
