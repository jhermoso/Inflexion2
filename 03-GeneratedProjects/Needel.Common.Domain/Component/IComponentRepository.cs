...
namespace Needel.Common.Domain
{
    ...
    /// de entidades <see cref="IComponent"/>.
    /// </summary>
    public interface IComponentRepository : IRepository<Component, Int32>
    {
        /// <summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        IEnumerable<Component> GetAllExceptIdAndChildren(Int32 id);
