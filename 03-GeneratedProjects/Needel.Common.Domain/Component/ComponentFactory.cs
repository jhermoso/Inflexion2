...
namespace Needel.Common.Domain
{
    ...
    /// <summary>
    /// Clase factoría para la creación de  una entidad de tipo <see cref="Component"/>.
    /// </summary>
    static public class ComponentFactory 
    {
        ...
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="ComponentFactory"/>.
        /// </summary>
        /// <remarks>
        /// Constructor vacío de la clase <see cref="ComponentFactory"/>.
        /// </remarks>
        /// <returns>
        ...
        /// </summary>
        /// <remarks>
        /// Crea una entidad de tipo <see cref="Component"/>
        /// </remarks>
        /// <param name="name"> 
        /// Name of component
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// Devuelve  una entidad de tipo <see cref="ComponentFactory"/>
        /// </returns>
        public static Component Create(string name, string partNumber)
        {
            // Creamos la nueva entidad.
            Component EntityComponent = new Component(  name, partNumber );
