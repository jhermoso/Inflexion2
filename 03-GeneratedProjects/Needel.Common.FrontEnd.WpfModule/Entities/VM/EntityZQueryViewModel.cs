...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class EntityZQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<EntityZViewModel, EntityZView, Int32>
    {
        ...
        public EntityZQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetEntityZ);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("EntityZPluralEntity");
        ...
        /// <param name="parentViewName"></param>
        public EntityZQueryViewModel( IList<EntityZDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new EntityZViewModel(item));
            }
        }
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            this._items = new ObservableCollection<EntityZViewModel>(result.Select(i => new EntityZViewModel(i/*, first, result.GetPrevious(i), result.GetNext(i), last*/, true)));
        ...
        public void MoveDataFromSrcToDest( EntityZQueryViewModel dataContextTarget, EntityZDto data)
        {
            ...
            if (this.Title.Equals("AllEntityZ"))
            {
                currentView.DataContext.AttachEntityZ(dataContextTarget, data);
                //move from "all" means to add new association
                //dataContextTarget.AttachEntityZ(data);
            }
            else
            {
                currentView.DataContext.RemoveEntityZ(this.Title, dataContextTarget, data);
                //move to "all" means to remove association
                //dataContextTarget.RemoveEntityZ(data);
            }
        }
        #endregion
