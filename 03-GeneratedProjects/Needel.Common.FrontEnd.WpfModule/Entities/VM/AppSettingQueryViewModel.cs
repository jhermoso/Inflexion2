...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class AppSettingQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<AppSettingViewModel, AppSettingView, Int32>
    {
        ...
        public AppSettingQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetAppSetting);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("AppSettingPluralEntity");
        ...
        /// <param name="parentViewName"></param>
        public AppSettingQueryViewModel(SpecificationDto baseFilter, string parentViewName )
            : this(parentViewName)
        {
        ...
        /// <param name="parentViewName"></param>
        public AppSettingQueryViewModel( IList<AppSettingDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new AppSettingViewModel(item));
            }
        }
            ...
            if (!this.IsBusy)
            {
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            this._items = new ObservableCollection<AppSettingViewModel>(result.Select(i => new AppSettingViewModel(i)));
