...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    public partial class AddressQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<AddressViewModel, AddressView, Int32>
    {
        ...
        public AddressQueryViewModel(string parentViewName = null)
            :base()
        {
        ...
        /// <param name="parentViewName"></param>
        public AddressQueryViewModel( IList<AddressDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new AddressViewModel(item));
            }
        }
            ...
            if (!this.IsBusy)
            {
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            this._items = new ObservableCollection<AddressViewModel>(result.Select(i => new AddressViewModel(i)));
