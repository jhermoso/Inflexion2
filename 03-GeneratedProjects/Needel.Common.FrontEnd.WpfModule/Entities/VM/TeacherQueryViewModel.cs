...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class TeacherQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<TeacherViewModel, TeacherView, Int32>
    {
        ...
        public TeacherQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetTeacher);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("TeacherPluralEntity");
        ...
        /// <param name="parentViewName"></param>
        public TeacherQueryViewModel(SpecificationDto baseFilter, string parentViewName )
            : this(parentViewName)
        {
        ...
        /// <param name="parentViewName"></param>
        public TeacherQueryViewModel( IList<TeacherDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new TeacherViewModel(item));
            }
        }
        ...
        public override void OnDeleteRecord(object parameter)
        {
            try
            {
                ...
                else if (this.ParentViewName == "StudentView")
                {
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            this._items = new ObservableCollection<TeacherViewModel>(result.Select(i => new TeacherViewModel(i/*, first, result.GetPrevious(i), result.GetNext(i), last*/, true)));
        ...
        public void MoveDataFromSrcToDest( TeacherQueryViewModel dataContextTarget, TeacherDto data)
        {
            ...
            dynamic currentView = views.FirstOrDefault(c => c as StudentView != null);

            if (this.Title.Equals("AllStudentsQueryVM"))
            {
                currentView.DataContext.AttachTeacher(dataContextTarget, data);
                //move from "all" means to add new association
                //dataContextTarget.AttachTeacher(data);
            }
            else
            {
                currentView.DataContext.RemoveTeacher(this.Title, dataContextTarget, data);
                //move to "all" means to remove association
                //dataContextTarget.RemoveTeacher(data);
            }
        }
        #endregion
