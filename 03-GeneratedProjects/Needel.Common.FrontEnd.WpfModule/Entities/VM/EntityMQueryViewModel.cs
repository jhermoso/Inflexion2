...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class EntityMQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<EntityMViewModel, EntityMView, Int32>
    {
        ...
        public EntityMQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetEntityM);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("EntityMPluralEntity");
        ...
        /// <param name="parentViewName"></param>
        public EntityMQueryViewModel( IList<EntityMDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new EntityMViewModel(item));
            }
        }
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            this._items = new ObservableCollection<EntityMViewModel>(result.Select(i => new EntityMViewModel(i/*, first, result.GetPrevious(i), result.GetNext(i), last*/, true)));
        ...
        public void MoveDataFromSrcToDest( EntityMQueryViewModel dataContextTarget, EntityMDto data)
        {
            ...
            if (this.Title.Equals("AllEntityM"))
            {
                currentView.DataContext.AttachEntityM(dataContextTarget, data);
                //move from "all" means to add new association
                //dataContextTarget.AttachEntityM(data);
            }
            else
            {
                currentView.DataContext.RemoveEntityM(this.Title, dataContextTarget, data);
                //move to "all" means to remove association
                //dataContextTarget.RemoveEntityM(data);
            }
        }
        #endregion
