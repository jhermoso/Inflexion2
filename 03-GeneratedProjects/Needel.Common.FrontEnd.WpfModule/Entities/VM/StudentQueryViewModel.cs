...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class StudentQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<StudentViewModel, StudentView, Int32>
    {
        ...
        public StudentQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetStudent);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("StudentPluralEntity");
        ...
        /// <param name="parentViewName"></param>
        public StudentQueryViewModel(SpecificationDto baseFilter, string parentViewName )
            : this(parentViewName)
        {
        ...
        /// <param name="parentViewName"></param>
        public StudentQueryViewModel( IList<StudentDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new StudentViewModel(item));
            }
        }
        ...
        public override void OnDeleteRecord(object parameter)
        {
            try
            {
                ...
                else if (this.ParentViewName == "TeacherView")
                {
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            this._items = new ObservableCollection<StudentViewModel>(result.Select(i => new StudentViewModel(i/*, first, result.GetPrevious(i), result.GetNext(i), last*/, true)));
        ...
        public void MoveDataFromSrcToDest( StudentQueryViewModel dataContextTarget, StudentDto data)
        {
            ...
            dynamic currentView = views.FirstOrDefault(c => c as TeacherView != null);
        
            if (this.Title.Equals("AllStudents"))
            {
                currentView.DataContext.AttachStudent(dataContextTarget, data);
                //move from "all" means to add new association
                //dataContextTarget.AttachStudent(data);
            }
            else
            {
                currentView.DataContext.RemoveStudent(this.Title, dataContextTarget, data);
                //move to "all" means to remove association
                //dataContextTarget.RemoveStudent(data);
            }
        }
        #endregion
