...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class ComponentQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<ComponentViewModel, ComponentView, Int32>
    {
        ...
        public ComponentQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetComponent);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("ComponentPluralEntity");
        ...
        } // ComponentQueryView Constructor
        ...
        /// <param name="parentViewName"></param>
        public ComponentQueryViewModel(SpecificationDto baseFilter, string parentViewName )
            : this(parentViewName)
        {
        ...
        /// <param name="parentViewName"></param>
        public ComponentQueryViewModel( IList<ComponentDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new ComponentViewModel(item));
            }
        }
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            this._items = new ObservableCollection<ComponentViewModel>(result.Select(i => new ComponentViewModel(i/*, first, result.GetPrevious(i), result.GetNext(i), last*/, true)));
