...
namespace Needel.Common.FrontEnd.WpfModule
{
    ...
    /// </summary>
    public partial class DepartmentQueryViewModel : Inflexion2.UX.WPF.MVVM.CRUD.QueryViewModel<DepartmentViewModel, DepartmentView, Int32>
    {
        ...
        public DepartmentQueryViewModel(string parentViewName = null)
            :base()
        {
            this.ParentViewName = parentViewName;
            if (!this.IsDesignTime)
            {
                this.ChangeActivateStatusCommand = new DelegateCommand(this.ResetDepartment);
            }
            ...
            var locBinding = new WPFLocalizeExtension.Extensions.LocTextExtension("DepartmentPluralEntity");
        ...
        /// <param name="parentViewName"></param>
        public DepartmentQueryViewModel( IList<DepartmentDto> collection, string parentViewName)
            : this(parentViewName)
        {
            if (collection != null)
            foreach (var item in collection)
            {
                this.Items.Add(new DepartmentViewModel(item));
            }
        }
                ...
                try
                {
                    ...
                    serviceClient.BeginGetPaged(this.Specification,                                                 (asyncResult) =>
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            this._items = new ObservableCollection<DepartmentViewModel>(result.Select(i => new DepartmentViewModel(i/*, first, result.GetPrevious(i), result.GetNext(i), last*/, true)));
