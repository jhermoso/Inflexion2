...
namespace Needel.Common.Test.InfrastructureLayer
{
    ...
    public class CommonCreateDaBase 
    {
        ...
        public void DataBaseCreateTest()
        {
            ...
            RootAggregateFrameworkUnitOfWorkFactory<Needel.Common.Infrastructure.BootstrapUnitOfWork> ctxFactory = new RootAggregateFrameworkUnitOfWorkFactory<BootstrapUnitOfWork>(connString);
