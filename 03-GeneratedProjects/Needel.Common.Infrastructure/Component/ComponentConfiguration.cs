...
namespace Needel.Common.Infrastructure
{
    ...
    /// </summary>
    /// <remarks>
    /// Mapea un objeto <see cref="Component"/>
    /// </remarks>
    public class ComponentConfiguration : EntityConfiguration<Component,Int32>
    {
        #region Constructors

        /// <summary>
        /// inicializa una nueva instancia de <see cref="ComponentConfiguration"/>.
        /// </summary>
        public ComponentConfiguration()
        {
            // remember the "Id" property is mapped in the base class. with a default name for the database table.
            this.ToTable("Component"); //Inflector.Underscore(typeof(Component).Name

            this.Property(e => e.Name).IsRequired();

            this.Property(e => e.PartNumber).IsRequired();

            this.Property(e => e.Description).IsOptional();

            this.HasMany<Component>(x => x.Children)
                ;
        }
        #endregion
    } // 
