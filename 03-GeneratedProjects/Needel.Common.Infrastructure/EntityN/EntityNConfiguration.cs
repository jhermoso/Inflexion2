...
namespace Needel.Common.Infrastructure
{
    ...
    /// </summary>
    /// <remarks>
    /// Mapea un objeto <see cref="EntityN"/>
    /// </remarks>
    public class EntityNConfiguration : EntityConfiguration<EntityN,Int32>
    {
        #region Constructors

        /// <summary>
        /// inicializa una nueva instancia de <see cref="EntityNConfiguration"/>.
        /// </summary>
        public EntityNConfiguration()
        {
            // remember the "Id" property is mapped in the base class. with a default name for the database table.
            this.ToTable("EntityN"); //Inflector.Underscore(typeof(EntityN).Name

            this.Property(e => e.Name).IsRequired();

            this.HasMany<MNZ>(x => x.MZs)
                .WithRequired(x => x.EntityN)
                .HasForeignKey(x => x.EntityN_Id)
                ;
        }
        #endregion
    } // 
