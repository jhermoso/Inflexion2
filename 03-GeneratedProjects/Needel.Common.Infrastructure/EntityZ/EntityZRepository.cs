...
namespace Needel.Common.Infrastructure
{
    ...
    /// obtener información a partir de entidades <see cref="EntityZ"/>.
    /// </summary>
    /// <remarks>
    /// Sin comentarios adicionales.
    /// </remarks>
    public partial class EntityZRepository : EFRepository<EntityZ,Int32>, IEntityZRepository
    {

        #region constructors
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="EntityZRepository"/>.
        /// </summary>
        /// <remarks>
        ...
        /// </exception>
        public EntityZRepository(DbContext dbContext) : base(dbContext) 
        {
        } // EntityZRepository Constructor
        #endregion
