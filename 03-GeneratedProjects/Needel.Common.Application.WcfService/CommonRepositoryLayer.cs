...
namespace Needel.Common.Application.WcfService
{
    ...
    public static class CommonRepositoryLayer
    {
        ...
        public static RootAggregateFrameworkUnitOfWorkFactory<Needel.Common.Infrastructure.BootstrapUnitOfWork> CtxFactory = null;
		...
		public static void IocRegistry()
        {
            ...
            CtxFactory = new RootAggregateFrameworkUnitOfWorkFactory<Needel.Common.Infrastructure.BootstrapUnitOfWork>(ConnString);//1
