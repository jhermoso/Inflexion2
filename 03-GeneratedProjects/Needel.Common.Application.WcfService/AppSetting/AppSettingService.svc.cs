...
namespace Needel.Common.Application.WcfService
{
    ...
    public partial class AppSettingService : IAppSettingService
    {
        ...
        public Int32 Create(AppSettingDto appSettingDto)
        {
            ...
            // Int32 identifier = data.Execute( appSettingDto);
        ...
        /// <returns></returns>
        public IEnumerable<AppSettingDto> GetAllExceptThis(Int32 appSettingId)
        {
            IEnumerable<AppSettingDto> result = null;
            try
            {
                result = this.service.GetAllExceptThis(appSettingId);
            }
            catch (Exception ex)
            {
                Inflexion2.Application.InternalException ie = new Inflexion2.Application.InternalException(ex);
        ...
        public IEnumerable<AppSettingDto> GetSelectedThese(IEnumerable<Int32> appSettingIds)
        {
            IEnumerable<AppSettingDto> result = null;
            try
            {
                result = this.service.GetSelectedThese(appSettingIds);
            }
            catch (Exception ex)
            {
                Inflexion2.Application.InternalException ie = new Inflexion2.Application.InternalException(ex);
        ...
        /// <returns></returns>
        public IEnumerable<AppSettingDto> GetAllExceptThese(IEnumerable<Int32> appSettingIds)
        {
            IEnumerable<AppSettingDto> result = null;
            try
            {
                result = this.service.GetAllExceptThese(appSettingIds);
            }
            catch (Exception ex)
            {
                Inflexion2.Application.InternalException ie = new Inflexion2.Application.InternalException(ex);
        ...
        /// <returns></returns>
        public IEnumerable<AppSettingDto> GetFiltered(SpecificationDto specificationDto)
        {
            IEnumerable<AppSettingDto> result = null;
            try
            {
