...
namespace Needel.Common.Application.WcfService
{
    ...
    public partial class AddressService : IAddressService
    {
        ...
        /// </return>
        public Int32 Create(AddressDto addressDto)
        {
            // opción 1
        ...
        /// requerida.
        /// </returns>
        public AddressDto GetById( Int32 addressId )
        {
            // opcion 1
            // Instanciamos el servicio de aplicación correspondiente mediante el contenedor de IoC.
        ...
        /// <returns></returns>
        public IEnumerable<AddressDto> GetAllExceptThis(Int32 addressId)
        {
            IEnumerable<AddressDto> result = null;
            try
            {
                result = this.service.GetAllExceptThis(addressId);
            }
            catch (Exception ex)
            {
                Inflexion2.Application.InternalException ie = new Inflexion2.Application.InternalException(ex);
        ...
        public IEnumerable<AddressDto> GetSelectedThese(IEnumerable<Int32> addressIds)
        {
            IEnumerable<AddressDto> result = null;
            try
            {
                result = this.service.GetSelectedThese(addressIds);
            }
            catch (Exception ex)
            {
                Inflexion2.Application.InternalException ie = new Inflexion2.Application.InternalException(ex);
        ...
        /// <returns></returns>
        public IEnumerable<AddressDto> GetAllExceptThese(IEnumerable<Int32> addressIds)
        {
            IEnumerable<AddressDto> result = null;
            try
            {
                result = this.service.GetAllExceptThese(addressIds);
            }
            catch (Exception ex)
            {
                Inflexion2.Application.InternalException ie = new Inflexion2.Application.InternalException(ex);
        ...
        /// <returns></returns>
        public IEnumerable<AddressDto> GetFiltered(SpecificationDto specificationDto)
        {
            IEnumerable<AddressDto> result = null;
            try
            {
