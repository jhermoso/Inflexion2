...
namespace Needel.Common.Application
{
    ...
    public static class CommonRepositoryLayer
    {
        ...
        /// 
        /// </summary>
        public static Needel.Common.Infrastructure.SetupNeedelAppSettings NeeddelAppSettings;
        ...
        {
            // Context Factory
            NeeddelAppSettings = new Needel.Common.Infrastructure.SetupNeedelAppSettings();
...
// bloque de cierre
        ...
        static private string ConnectionString()
        {
            ...
            string result = null;
            try
            {   // conection string in appconfig

                result = Needel.Common.Infrastructure.SetupNeedelAppSettings.Instance.SelectedConnection.connectionString;
