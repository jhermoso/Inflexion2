...
namespace Needel.Common.Application
{
    ...
    /// de tipo <see cref="Needel.Common.Application.IEntityZServices"/>.
    /// </summary>
    public interface IEntityZServices : IEfApplicationServiceBase<EntityZDto, Needel.Common.Domain.EntityZ, Int32>
    {
    } // end class ICreateEntityZ
