...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="AppSettingMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="AppSettingDto"/> con una entidad <see cref="AppSettingMapper"/>.
    /// </remarks>
    public interface IAppSettingMapper : IDataEntityMapper<AppSettingDto, IAppSetting, Int32>
    {
