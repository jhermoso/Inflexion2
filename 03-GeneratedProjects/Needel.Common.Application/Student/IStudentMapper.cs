...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="StudentMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="StudentDto"/> con una entidad <see cref="StudentMapper"/>.
    /// </remarks>
    public interface IStudentMapper : IDataEntityMapper<StudentDto, Student, Int32>
    {
