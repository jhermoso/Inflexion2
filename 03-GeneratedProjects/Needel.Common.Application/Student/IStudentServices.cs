...
namespace Needel.Common.Application
{
    ...
    /// de tipo <see cref="Needel.Common.Application.IStudentServices"/>.
    /// </summary>
    public interface IStudentServices : IEfApplicationServiceBase<StudentDto, Needel.Common.Domain.Student, Int32>
    {
    } // end class ICreateStudent
