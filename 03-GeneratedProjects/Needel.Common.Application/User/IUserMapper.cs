...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="UserMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="UserDto"/> con una entidad <see cref="UserMapper"/>.
    /// </remarks>
    public interface IUserMapper : IDataEntityMapper<UserDto, IUser, Int32>
    {
