...
namespace Needel.Common.Application
{
    ...
    /// de tipo <see cref="Needel.Common.Application.IEntityMServices"/>.
    /// </summary>
    public interface IEntityMServices : IEfApplicationServiceBase<EntityMDto, Needel.Common.Domain.EntityM, Int32>
    {
    } // end class ICreateEntityM
