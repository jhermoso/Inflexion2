...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="EntityMMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="EntityMDto"/> con una entidad <see cref="EntityMMapper"/>.
    /// </remarks>
    public interface IEntityMMapper : IDataEntityMapper<EntityMDto, EntityM, Int32>
    {
