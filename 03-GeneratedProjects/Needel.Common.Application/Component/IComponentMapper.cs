...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="ComponentMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="ComponentDto"/> con una entidad <see cref="ComponentMapper"/>.
    /// </remarks>
    public interface IComponentMapper : IDataEntityMapper<ComponentDto, Component, Int32>
    {
