...
namespace Needel.Common.Application
{
    ...
    /// de tipo <see cref="Needel.Common.Application.ITeacherServices"/>.
    /// </summary>
    public interface ITeacherServices : IEfApplicationServiceBase<TeacherDto, Needel.Common.Domain.Teacher, Int32>
    {
    } // end class ICreateTeacher
