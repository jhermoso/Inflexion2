...
namespace Needel.Common.Application
{
    ...
    /// de tipo <see cref="Needel.Common.Application.IEntityNServices"/>.
    /// </summary>
    public interface IEntityNServices : IEfApplicationServiceBase<EntityNDto, Needel.Common.Domain.EntityN, Int32>
    {
    } // end class ICreateEntityN
