...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="EntityNMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="EntityNDto"/> con una entidad <see cref="EntityNMapper"/>.
    /// </remarks>
    public interface IEntityNMapper : IDataEntityMapper<EntityNDto, EntityN, Int32>
    {
