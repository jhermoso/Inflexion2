...
namespace Needel.Common.Application
{
    ...
    /// de tipo <see cref="Needel.Common.Application.IMNZServices"/>.
    /// </summary>
    public interface IMNZServices : IEfValueObjectApplicationServiceBase<MNZDto, Needel.Common.Domain.MNZ>
    {
    } // end class ICreateMNZ
