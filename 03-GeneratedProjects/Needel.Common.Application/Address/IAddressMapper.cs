...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="AddressMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="AddressDto"/> con una entidad <see cref="AddressMapper"/>.
    /// </remarks>
    public interface IAddressMapper : IDataEntityMapper<AddressDto, IAddress, Int32>
    {
