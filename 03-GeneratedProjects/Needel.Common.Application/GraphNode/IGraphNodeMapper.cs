...
namespace Needel.Common.Application
{
    ...
    /// <summary>
    /// Clase pública encargada de mapear los datos de una entidad <see cref="GraphNodeMapper"/>.
    /// </summary>
    /// <remarks>
    /// Mapea los datos del Dto <see cref="GraphNodeDto"/> con una entidad <see cref="GraphNodeMapper"/>.
    /// </remarks>
    public interface IGraphNodeMapper : IDataEntityMapper<GraphNodeDto, GraphNode, Int32>
    {
