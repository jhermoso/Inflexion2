...
namespace Needel.Common.Application.WcfService.Contracts
{
    ...
    public partial interface IDepartmentService
    {
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<DepartmentDto> GetAllExceptThis(Int32 departmentId);

        [OperationContract, FaultContract(typeof(FaultObject))]
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<DepartmentDto> GetSelectedThese(IEnumerable<Int32> departmentIds);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<DepartmentDto> GetAllExceptThese(IEnumerable<Int32> departmentIds);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<DepartmentDto> GetFiltered(SpecificationDto specificationDto);
