...
namespace Needel.Common.Application.WcfService.Contracts
{
    ...
    public partial interface IMNZService
    {
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        PagedElements<MNZDto> GetPaged(SpecificationDto specificationDto);

        [OperationContract, FaultContract(typeof(FaultObject))]
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<MNZDto> DeleteAll();
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<MNZDto> GetAllExceptThis(MNZDto mNZDto);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<MNZDto> GetAllExceptThese(IEnumerable<MNZDto> mNZs);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<MNZDto> GetFiltered(SpecificationDto specificationDto);

        #endregion
    } // end public partial interface MNZService
