...
namespace Needel.Common.Application.WcfService.Contracts
{
    ...
    public partial interface IStudentService
    {
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        StudentDto GetById(Int32 studentId );
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        PagedElements<StudentDto> GetPaged(SpecificationDto specificationDto);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<StudentDto> GetAllExceptThis(Int32 studentId);

        [OperationContract, FaultContract(typeof(FaultObject))]
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<StudentDto> GetSelectedThese(IEnumerable<Int32> studentIds);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<StudentDto> GetAllExceptThese(IEnumerable<Int32> studentIds);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<StudentDto> GetFiltered(SpecificationDto specificationDto);

        #endregion
    } // end public partial interface StudentService
