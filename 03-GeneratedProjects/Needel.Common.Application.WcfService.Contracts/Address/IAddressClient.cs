...
namespace Needel.Common.Application.WcfService.Contracts
{
    ...
    public partial interface IAddressClient
    {
        ...
        IEnumerable<AddressDto> GetAllExceptId(Int32 addressId);
  

        IEnumerable<AddressDto> GetSelectedIds(IEnumerable<Int32> addressIds);


        IEnumerable<AddressDto> GetAllExceptIds(IEnumerable<Int32> addressIds);
