...
namespace Needel.Common.Application.WcfService.Contracts
{
    ...
    public partial interface IAddressService
    {
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<AddressDto> GetAllExceptThis(Int32 addressId);

        [OperationContract, FaultContract(typeof(FaultObject))]
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<AddressDto> GetSelectedThese(IEnumerable<Int32> addressIds);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<AddressDto> GetAllExceptThese(IEnumerable<Int32> addressIds);
        ...
        [FaultContract(typeof(ValidationException))]
        [FaultContract(typeof(InternalException))]
        IEnumerable<AddressDto> GetFiltered(SpecificationDto specificationDto);
