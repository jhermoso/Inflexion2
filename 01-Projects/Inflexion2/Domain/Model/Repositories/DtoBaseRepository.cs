...
namespace Inflexion2.Domain
{
    ...
    public abstract class DtoBaseRepository<TDto, TEntity, TIdentifier> : IDtoRepository<TDto, TEntity, TIdentifier>
        ...
        where TIdentifier : IComparable<TIdentifier>, IEquatable<TIdentifier>
    {
        ...
        /// <returns><see cref="Inflexion2.Domain.IRepository{TEntity, TIdentifier}"/></returns>
        public IEnumerable<TDto> GetBySpec(ISpecification<TEntity> specification)
        {
        ...
        protected abstract IQueryable<TDto> Query();
