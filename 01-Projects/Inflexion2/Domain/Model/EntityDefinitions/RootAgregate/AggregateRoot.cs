...
namespace Inflexion2.Domain
{
    ...
    public abstract class AggregateRoot<TEntity, TIdentifier> : Entity<TEntity, TIdentifier>, IAggregateRoot<TEntity, TIdentifier>, IEntity<TIdentifier>
        where TEntity : IAggregateRoot<TEntity, TIdentifier>, IEntity<TIdentifier>, System.IEquatable<TEntity>, System.IComparable<TEntity>// si no utilizamos interfaces para los poco podemos restringir con AggregateRoot<TEntity, TIdentifier>
        where TIdentifier : System.IEquatable<TIdentifier>, System.IComparable<TIdentifier>
    {
         ...
         public  Boolean CanBeDeleted()
        {
            ...
            foreach (PropertyInfo property in navigationProperties)
            {
                ...
                {
                    // si podemos obtener el elemento 0 de una collección que tiene un primer elemento entonces
                    if (ReflectionExtensions.IsNonStringEnumerable(property))
                    {
                        object c = property.GetValue(this, null);
                        ICollection col = c as ICollection;
                        if (col != null)
                        {
                            var result =  col.Count <= 0 ;
                            return result;
                        }
                    }
                }
        ...
        {
            return typeof(AggregateRoot<TEntity, TIdentifier>).GetCustomAttributes(typeof(LogicalDeleteAttribute), true).Any(); 
        }
    }
}
