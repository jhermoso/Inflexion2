...
[assembly: XmlnsDefinition("http://schemas.InflexionSoftware.com/xaml/presentation", "Inflexion2.UX.WPF.Localization.Engine")]
[assembly: XmlnsDefinition("http://schemas.InflexionSoftware.com/xaml/presentation", "Inflexion2.UX.WPF.Localization.Extensions")]
//// Assign a default namespace prefix for the schema
[assembly: XmlnsPrefix("http://schemas.InflexionSoftware.com/xaml/presentation", "IS")]

namespace Inflexion2.UX.WPF.Localization.Engine
{
    /// <summary>
    ...
    public sealed class LocalizeDictionary : DependencyObject
    {
        ...
        /// </summary>
        [DesignOnly(true)] // especificamos que el valor de esta propiedad de dependencia solo se puede establecer en tiempo de diseño.
        ...
        public static void ParseKey(string inKey, out string outAssembly, out string outDict, out string outKey)
        {
            ...
            {
                // Si el valor pasado es un nulo o vacio lanzamos una excepción de ejecución.
                if (!Instance.GetIsInDesignMode())
                {
