...
using Inflexion2.UX.WPF.Localization.Engine;

namespace Inflexion2.UX.WPF.Localization.BaseExtensions
{
    /// <summary>
    ...
    {
        // La clase MarkupExtension proporciona una clase base para las implementaciones de extensión de marcado XAML: 
        //      Para ampliar información consultar la sección de comentarios de http://msdn.microsoft.com/es-es/library/system.windows.markup.markupextension.aspx
        // La interface IWeakEventListener se utiliza para implementar el patrón de evento debil.
        //      Para ampliar información consultar la sección de comentarios de http://msdn.microsoft.com/es-es/library/system.windows.markup.markupextension.aspx
        // La interface INotifyPropertyChanged se implementa para notificar el cambio de una propiedad de dependencia.
        ...
        {
            // Inicializa la colección de los objetos de dependencia asiganados.
        ...
        /// <remarks>
        /// Este constructor registra el <see cref="EventHandler"/><c>OnCultureChanged</c> on <c>LocalizeDictionary</c>
